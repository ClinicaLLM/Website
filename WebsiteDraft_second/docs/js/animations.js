document.addEventListener("DOMContentLoaded", () => {
    ...
    const spindleHero = document.querySelector('#spindle-page .page-banner');
    
    if (weaveHero) initParticles(weaveHero, 25, '#10B981');
    if (spindleHero) initParticles(spindleHero, 25, '#8B5CF6');
    ...
    // ===========================================
    // ORBIT ANIMATION (Weave/Spindle Heroes)
    // ===========================================
